...
Inicialmente todo Personagem pode distribuir 1 ponto em 2 Atributos, da forma como bem quiser, desde que não seja no seu Atributo de Classe (veja [[Classes]]). A Classe do Personagem determina o seu Atributo de Classe. O Atributo de Classe aumenta a cada Nível de Personagem, sempre se equivalendo ao mesmo. Além disso, toda vez em que um Personagem sobe de Nível, ele recebe 1 ponto para gastar em 1 Atributo, desde que o valor final não exceda o Nível atual do Personagem.

Perceba como você não var rolar dATB (veja [[Mecânica central]]) do seu Atributo de Classe no Nível 1. Isso representa que seu personagem é um completo iniciante.
